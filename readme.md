...
🔗 https://sameer-sde.github.io/BMR-TDEE-Estimator/

---

## 📖 Overview
This project is a web-based application that calculates a user's **Basal Metabolic Rate (BMR)** and estimated daily calorie needs based on their:
- 👤 Gender  
- 📏 Height  
- ⚖️ Weight  
- 🎂 Age  
...
The focus is on 🧠 clean logic, 🧩 modular JavaScript, and 🎨 user-friendly results.
